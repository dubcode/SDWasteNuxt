...
export default {
  ...
  methods: {
    ...
    // get posts method
    getPosts () {
        axios.get(process.env.baseUrl + '/team_members')
        .then((response) => {
    ...
    getPage () {
        axios.get(process.env.baseUrl + '/pages/13274?_embed')
        .then((response) => {
