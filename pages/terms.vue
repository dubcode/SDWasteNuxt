...
export default {
  ...
  asyncData () {
    return axios.get(process.env.baseUrl + '/pages/13437?_embed').then((response) => {
  ...
  head () {
    return {
      ...
      script: [
        {
          src: 'https://sdwaste.co.uk/wp-content/plugins/gravity-forms-iframe-develop/assets/scripts/gfembed.min.js',
          body: true
        }
      ],
    }
