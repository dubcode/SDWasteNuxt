<template>
  <div class="row">
    <Hero
      ...
      :hero-button-two-text="hero_button_two_text"
      :hero-button-two-url="hero_button_two_url"
      :hero-button-two-class="hero_button_two_class"
      :hero-button-two-target="hero_button_two_target"
    />
    <div class="row">
        <div class="ctr">
...
export default {
  ...
  asyncData () {
    return axios.get(process.env.baseUrl + '/pages/13284?_embed').then((response) => {
      ...
      return {
        ...
        hero_button_two_text: page.acf.hero.button_two_title,
        hero_button_two_url: page.acf.hero.button_two_url,
        hero_button_two_class: page.acf.hero.button_two_class,
        hero_button_two_target: page.acf.hero.button_two_target,
